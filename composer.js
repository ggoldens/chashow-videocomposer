...
var composer = function (zip_file,cb) {
  ...
  result.on("close", function() {
    ...
    //  console.log("ffmpeg grid=", e.files.length);
      ...
      if (e.files.length == 1) {
        ...
        filter = "-filter_complex \"[0]scale=iw/3:-1,pad=3*iw:3*ih:0:120[base];[1]scale=iw/3:-1[middle];[2]scale=iw/3:-1[right];[base][middle]overlay=main_w/3:120[base];[base][right]overlay=main_w/3*2:120";
